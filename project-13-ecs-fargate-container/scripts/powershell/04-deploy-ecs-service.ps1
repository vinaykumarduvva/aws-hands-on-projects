...
Write-Host "Waiting for ECS service to become stable (This usually takes 2-4 minutes)..."
aws ecs wait services-stable --cluster $CLUSTER_NAME --services $SERVICE_NAME

Write-Host "ECS Service created and stable! You can now access the app at: http://$ALB_DNS"
